...
user2 = User.create(first_name:"Bilbo", last_name: "Baggins", email:"bilbo.baggins@gmail.com", password:"popfiction")
...
##Simpson
place1 = Place.create(name: "Simpsons' house", address: "742 Evergreen Terrace, Springfield, Oregon, USA", beds: 4, price:27389 , user: user1,
description:"Charming family home in Springfield, featuring 4 bedrooms, a spacious living room, vintage kitchen, and a welcoming garden. Perfect for a fun family vacation!" )
...
#Hobbit
place2 = Place.create(name: "Bag End", address: "501 Buckland Road, Matamata 3472, Nouvelle-Zélande", beds:2, price:324, user: user2,
description:"Charming cave house in Hobbiton, featuring 1 cozy bedroom, a comfortable living room, a rustic kitchen, and a lush garden. Perfect for a peaceful retreat in the heart of Middle-earth, just steps away from enchanting landscapes and hiking trails!" )
...
#Ghostbusters
place3 = Place.create(name: "Ghostbusters' caserne", address: "14 N Moore St TriBeCa, New York, NY 10013-2413", beds:10, price:12734, user: user3,
description:"Old firehouse in New York, converted into the Ghostbusters' headquarters. Spacious rooms, unique decor, and modern amenities. Perfect for paranormal enthusiasts and urban adventurers!" )
...
#Addams
place4 = Place.create(name: "The Addams' Manor", address: "E. Grand St., Palatine Bridge, New York", beds:5, price:2178, user: user4,
description:"A gothic and mysterious house, spacious with 5 bedrooms, an extravagant living room, and an enigmatic garden. Strange ambiance and unique decor, perfect for lovers of the unusual and unexpected.")
...
#Cendrillon
place5 = Place.create(name: "Disney's castle", address: "Bd de Parc, 77700 Coupvray", beds:20, price: 10245, user: user5,
description:"A stunning fairytale castle, featuring elegant rooms, grand halls, and enchanting gardens. A magical place for an unforgettable royal experience.")
...
#Ken
place6 = Place.create(name: "Ken's villa", address: "23825 Stuart Ranch Rd, Malibu, CA 90265, États-Unis", beds: 6, price:18984, user: user6,
description:"Ken's stylish house, featuring a large pool, a perfect barbecue area for entertaining friends, and a corner dedicated to his love for horses. Chic and laid-back ambiance guaranteed!")
...
#Barbie
place7 = Place.create(name: "Barbie's Dreamhouse", address: "23835 Stuart Ranch Rd, Malibu, CA 90265, États-Unis", beds: 6, price: 22456, user: user6,
description:"Barbie's glamorous and colorful house, featuring a pool, elegant living room, modern kitchen, and vibrant garden. A dreamy, chic stay in a fairytale setting!")
...
#Shrek
place8 = Place.create(name: "Shrek's Swamp", address: "Tomintoul, Ballindalloch AB37 9HU, Royaume-Uni", beds:2, price: 32 , user: user7,
description:"Charming mud house in the countryside, with a cozy living room, rustic kitchen, and large garden. Perfect for a peaceful, nature-filled getaway, far from the city.")
...
#Downtown Abbey
place9 = Place.create(name: "Downtown Abbey", address: "Highclere Park, Highclere, Newbury RG20 9RN, Royaume-Uni", beds:20, price: 29753, user: user8,
description:"Elegant old-world castle, featuring luxurious rooms, refined lounges, and immaculate gardens. Experience aristocratic living in a historic and lavish setting.")
...
#Hogwart
place10 = Place.create(name: "Hogwarts", address: "Dornie, Kyle of Lochalsh IV40 8DX, Royaume-Uni", beds:280, price: 37823, user: user9,
description:"A majestic castle with vast halls, secret rooms, and hidden gardens. An enchanting place for a unique stay in the heart of magic and mystery.")
...
#Tatouine
place11 = Place.create(name: "Luke's house", address: "Hôtel Dakyanus, Route El Ferch BP 234, C207, Tataouine 3200, Tunisie", beds:4, price: 156, user: user10,
description:"A unique cave house on Tatooine, featuring breathtaking views, spacious living areas, and a desert ambiance. Perfect for an isolated retreat under two suns." )
...
#BreakingBad
place12 = Place.create(name: "Heisenberg's caravan", address: "1 Civic Plz NW, Albuquerque, NM 87102, États-Unis", beds: 2, price:184, user: user11,
description:"A vintage and authentic caravan, featuring a cozy space, equipped kitchen, and desert views. Chemistry discovery activities available for a unique experience. Perfect for adventure and science enthusiasts!")
