...
#
##Simpson
place1 = Place.create(address: "742 Evergreen Terrace, Springfield, Oregon, USA", beds: 4, price:27389 , user: user1, description:"Charmante maison familiale à Springfield, avec 4 chambres, salon spacieux, cuisine vintage et jardin accueillant. Idéale pour des vacances fun en famille !" )
...
#Hobbit
place2 = Place.create(address: "501 Buckland Road, Matamata 3472, Nouvelle-Zélande", beds:2, price:324, user: user2, description:"Charmante maison troglodyte à Hobbiton, avec 1 chambre cosy, un salon confortable, une cuisine rustique et un jardin verdoyant. Idéale pour une retraite paisible au cœur de la Terre du Milieu, à deux pas des paysages enchanteurs et des sentiers de randonnée !" )
...
#Addams
place4 = Place.create(address: "E. Grand St., Palatine Bridge, New York", beds:5, price:2178, user: user4, description:"Maison gothique et mystérieuse, spacieuse avec 5 chambres, un salon extravagant, et un jardin énigmatique. Ambiance étrange et décor unique, idéale pour les amateurs de l'étrange et de l’inattendu.")
...
#Cendrillon
place5 = Place.create(address: "Bd de Parc, 77700 Coupvray", beds:20, price: 10245, user: user5, description:"Splendide château de conte de fées, avec chambres élégantes, grandes salles et jardins féériques. Lieu magique pour une expérience royale inoubliable.")
...
#Barbie
place7 = Place.create(address: "23835 Stuart Ranch Rd, Malibu, CA 90265, États-Unis", beds: 6, price: 22456, user: user6, description:"Maison glam et colorée de Barbie, avec piscine, salon élégant, cuisine moderne et jardin vibrant. Un séjour féérique et chic dans un cadre de rêve !")
...
#Hogwart
place10 = Place.create(address: "Dornie, Kyle of Lochalsh IV40 8DX, Royaume-Uni", beds:280, price: 37823, user: user9, description:"Château majestueux avec salles vastes, chambres secrètes, et jardins enchâssés. Un lieu enchanteur pour un séjour unique au cœur de la magie et du mystère.")
...
#Tatouine
place11 = Place.create(address: "Hôtel Dakyanus, Route El Ferch BP 234, C207, Tataouine 3200, Tunisie", beds:4, price: 156, user: user10, description:"Maison troglodyte unique sur Tatouine, avec vues imprenables, espace spacieux et ambiance désertique. Parfaite pour une retraite isolée sous deux soleils." )
