...
user5 = User.create(first_name:"Cinderella", last_name:"Princess", email:"cendrillon@gmail.com", password:"popfiction")
...
#Hobbit
place2 = Place.create(name: "Bilbo's House", address: "501 Buckland Road, Matamata 3472, New Zealand", beds:2, price:324, user: user2, description:"Charmante maison troglodyte à Hobbiton, avec 1 chambre cosy, un salon confortable, une cuisine rustique et un jardin verdoyant. Idéale pour une retraite paisible au cœur de la Terre du Milieu, à deux pas des paysages enchanteurs et des sentiers de randonnée !" )
...
#Addams
place4 = Place.create(name: "The Addams' Manor", address: "E. Grand St., Palatine Bridge, New York, USA", beds:5, price:2178, user: user4, description:"Maison gothique et mystérieuse, spacieuse avec 5 chambres, un salon extravagant, et un jardin énigmatique. Ambiance étrange et décor unique, idéale pour les amateurs de l'étrange et de l’inattendu.")
...
#Cendrillon
place5 = Place.create(name: "Disney's castle", address: "Bd de Parc, 77700 Coupvray, France", beds:20, price: 10245, user: user5, description:"Splendide château de conte de fées, avec chambres élégantes, grandes salles et jardins féériques. Lieu magique pour une expérience royale inoubliable.")
...
#Barbie
place7 = Place.create(name: "Barbie's Dreamhouse", address: "23835 Stuart Ranch Rd, Malibu, CA 90265, USA", beds: 6, price: 22456, user: user6, description:"Maison glam et colorée de Barbie, avec piscine, salon élégant, cuisine moderne et jardin vibrant. Un séjour féérique et chic dans un cadre de rêve !")
...
#Shrek
place8 = Place.create(name: "Shrek's Swamp", address: "Tomintoul, Ballindalloch AB37 9HU, United Kingdom", beds:2, price: 32 , user: user7, description:"Charmante maison en boue à la campagne, avec salon cosy, cuisine rustique et grand jardin. Idéale pour un séjour tranquille et naturel, loin de la ville.")
...
#Hogwart
place10 = Place.create(name: "Hogwarts", address: "Dornie, Kyle of Lochalsh IV40 8DX, United Kingdom", beds:280, price: 37823, user: user9, description:"Château majestueux avec salles vastes, chambres secrètes, et jardins enchâssés. Un lieu enchanteur pour un séjour unique au cœur de la magie et du mystère.")
...
#Tatouine
place11 = Place.create(name: "Luke's house", address: "Hôtel Dakyanus, Route El Ferch BP 234, C207, Tataouine 3200, Tunisia", beds:4, price: 156, user: user10, description:"Maison troglodyte unique sur Tatouine, avec vues imprenables, espace spacieux et ambiance désertique. Parfaite pour une retraite isolée sous deux soleils." )
...
#BreakingBad
place12 = Place.create(name: "Walker's trailor", address: "1 Civic Plz NW, Albuquerque, NM 87102, USA", beds: 2, price:184, user: user11, description:"Caravane vintage et authentique, avec espace cosy, cuisine équipée et vue désertique. Activité découverte de la chimie disponible pour une expérience unique. Parfaite pour les amateurs d'aventure et de science !")
